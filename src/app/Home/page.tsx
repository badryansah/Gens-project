            ...
            <div className="md:col-span-5 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                  className="relative bg-gradient-to-r from-blue-400 to-gray-200 rounded-xl overflow-hidden h-[200px] lg:h-[250px] shadow-lg group"
                >
                  <div className="absolute top-0 left-0 p-6 z-10 max-w-[60%]">
                    <motion.h3
                      initial={{ opacity: 0, y: -10 }}
                  ...
                  >
                    <Image
                      src={Parfume}
                      alt="Parfume"
                      className="absolute bottom-4 right-4 w-1/2 h-auto transform group-hover:scale-110 transition-transform duration-700"
                    />
                  </motion.div>
                </motion.div>
