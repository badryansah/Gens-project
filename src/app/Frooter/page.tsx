...
const Footer = () => {
  return (
    <footer className="bg-white pt-8 md:pt-12 pb-6 border-t">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8 md:mb-12">
          <div>
            <h2 className="text-black text-lg md:text-xl font-bold mb-4 md:mb-6">
          ...
          <div>
            <h2 className="text-black text-xl md:text-2xl font-bold mb-4 md:mb-6">
              Grab and ship
            </h2>
